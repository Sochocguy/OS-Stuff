...
int main() {
    ...
    final[0].array = NULL;
    final[0].size = 40;
    final[0].array = (int *)malloc(sizeof(int)*final[0].size);
    //Create the array and store the size of each array and the array itself into the Info struct
    info[0].array = NULL;
    info[0].size = 16;
    info[0].array = (int *)malloc(sizeof(int)*info[0].size);
    
    info[1].array = NULL;
    info[1].size = 35;
    info[1].array = (int *)malloc(sizeof(int)*info[1].size);
    
    info[2].array = NULL;
    info[2].size = 40;
    info[2].array = (int *)malloc(sizeof(int)*info[2].size);
